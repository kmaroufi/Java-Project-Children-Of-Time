...
public class GameEngine {
    ...
    public void shoppingCommands(){
        Display.printInEachLine("Welcome To The ShopPackage!");
        while(true) {
            ...
            Display.printInEachLine("3 - Buy Or Sell ItemPackage");
            Display.printInEachLine("4 - Show Your Wealth");
            Display.printInEachLine("5 - Exit ShopPackage");
...
//
//                } else if (classOfEffectedObjects == ClassName.ItemPackage) {
//
//                }//...
//            }
    ...
    private void creatingDefaultItems() {
        {
            ...
            Pair<String, Hero> pair = new Pair<>("ali", GameEngine.listOfHeroes.get(0));
        ...
        }
        {
            ...
            PerkItem perkItem = new PerkItem(itemHandler, perk, true);
            ItemProperties<PerkItem> itemProperties = new ItemProperties<PerkItem>(perkItem, 2, 0, 4, 0, 0);
            Shop.listOfPerkItems.add(itemProperties);
        }
        {
            // Sword
            ...
            ItemProperties<PerkItem> itemProperties = new ItemProperties<PerkItem>(perkItem, 0, 0, 25, 0.5, 0);
            Shop.listOfPerkItems.add(itemProperties);
        }
        {
            // Energy Boots
...
//        }
    ...
    public void doCampaign(int battleNumber) {                                               // do Campaign Game (not Custom Game)
        ...
        while (true) {
            ...
            Display.printInEachLine("3 - Show ShopPackage items");
                        ...
                        for (Skill skill : hero.getSkills()) {
                            if (command.equalsIgnoreCase(hero.getName() + " " + skill.getName() + "?")) {//(hero name) + “ “ +(ability name) + "?"
                                ...
                                if (skill.getCurrentGrade() == 0) {
                                    Display.printInEachLine("This AbilityPackage is not acquires!");
                                }
                                else {
...
//
                                    ...
                                    Display.printInEachLine("This ItemPackage isn't acquires!");
                                    break;
                                    ...
                                    Display.printInEachLine("Your desired ItemPackage is still in cooldown." + "remaining cooldown is " + skillItem.getRemainingCooldown());
                                    break;
