 ...
 */
public class SelectHeroesFrame extends JFrame implements ActionListener,GameFrame {
    ...
    public SelectHeroesFrame(){
        String[] columnNames = {"Select", "Name", "Class", "Health", "Magic Point", "Attack Power", "Abilities", "Description"};
        this.OKButton = new JButton();
        this.backButton = new JButton();
        this.titleLabel = new JLabel(new ImageIcon("./resources/images/PleaseSelectYourHeroes.png"));
    ...
    public void setComponentsBounds() {
        this.OKButton.setBounds(500, 450, OKButton.getWidth(), OKButton.getHeight());
        this.backButton.setBounds(50, 450, backButton.getWidth(), backButton.getHeight());
...
//        this.tableModel.setValueAt("Mohsen", 0, 1);
    ...
    public static void main(String[] args) {
        SelectHeroesFrame selction = new SelectHeroesFrame();
    }
}
