 ...
 */
public class SelectEnemiesFrame extends JFrame implements GameFrame,ActionListener{
    ...
    public SelectEnemiesFrame(){
        String[] columnNames = {"Select", "Name", "Class", "Health", "Magic Point", "Attack Power", "Abilities", "Description"};
        this.OKButton = new JButton();
        this.backButton = new JButton();
        this.titleLabel = new JLabel(new ImageIcon("./resources/images/PleaseSelectEnemies.png"));
    ...
    public void setDataColumns(){
        this.tableModel.addColumn("Count");
...
//        this.tableModel.setValueAt("Mohsen", 0, 1);
    ...
    public static void main(String[] args) {
        SelectEnemiesFrame selction = new SelectEnemiesFrame();
    }
}
